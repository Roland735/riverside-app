...
import SubjectPage from "@/app/components/admin/SubjectHome";
import ProfilePage from "@/app/components/admin/ProfileHome";
        ...
        return (
            <>
                ...
                <div className="md:flex justify-between  w-full items-center  shadow-2xl light-border">
                    <ProfilePage regNumber={session.user.regNumber} image={session.user.image} name={session.user.firstname} lastname={session.user.lastname} />
                </div>
