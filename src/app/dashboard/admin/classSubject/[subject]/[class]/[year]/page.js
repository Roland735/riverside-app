...
import GradeAnalysisPage from "@/app/components/admin/GradeHome";
import SubjectPage from "@/app/components/admin/ClassSubject";
        ...
        return (
            <
                ...
                <div className="md:flex justify-between  py-3 w-full items-center  shadow-2xl light-border">
                    <SubjectPage className={className} subject={subject} year={year} />
                </div>
